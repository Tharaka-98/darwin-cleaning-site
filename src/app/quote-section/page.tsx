...
export default function ContactSection() {
  ...
  return (
    <section className="w-full pt-10 md:px-12 pb-8 md:pt-12 px-6 mt-18 lg:mt-54 xl:mt-54 bg-white dark:bg-[#0b0f12]">
      <div className="font-poppins text-[28px] md:text-[40px] md:hidden block xl:text-[52px] font-semibold ">
        Contact Us
      </div>
      <div className="max-w-8xl mx-auto pt-6  md:pt-4 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-24">
        ...
        <div className="">
          ...
          <div className="mb-3">
            ...
            <p className="font-poppins text-[14px] cursor-pointer text-[#243056] dark:text-gray-100 md:text-[16px]">
              ...
              >
                info@cleanspacesfacilities.com.au
              </a>
            </p>
          </div>

          <div className="mb-6">
            <div className="font-medium md:text-lg font-poppins text-[#243056] dark:text-gray-100">
              📍 Head Office Address
            </div>
            <p className="font-poppins text-[14px] md:text-[16px] text-[#243056] dark:text-gray-100">
        ...
        {/* RIGHT SIDE - FORM */}
        <div className="bg-gray-50 dark:bg-[#0f1216] p-8 rounded-lg shadow-xl dark:shadow-none">
          <h2 className="text-2xl lg:text[32px] font-semibold font-poppins mb-6 text-blue-900 dark:text-gray-100">
            SEND US A MESSAGE
          </h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              placeholder="Name"
              required
              className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#0f1216] text-black dark:text-gray-100 px-4 py-2 rounded"
              value={formData.name}
              onChange={(e) =>
            ...
            <textarea
              placeholder="Inquiry"
              required
              className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#0f1216] text-black dark:text-gray-100 px-4 py-2 rounded h-28"
            ...
            <button
              ...
              className={`${
                isSending
                  ...
                  : "bg-white dark:bg-transparent font-poppins text-blue-900 dark:text-gray-100 border-2 border-blue-900 dark:border-gray-700 hover:bg-blue-900 hover:text-white dark:hover:bg-white dark:hover:text-blue-900"
