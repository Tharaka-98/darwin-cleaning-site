  ...
  return (
    <div className="w-full md:mt-12 mt-8 lg:mt-32 h-screen flex flex-col items-center justify-center bg-gray-100 text-center py-16">
      <div className="max-w-2xl px-6">
        <h1 className="text-4xl font-bold text-pink-600 mb-4 font-poppins">Coming Soon!</h1>
        ...
        <p className="text-lg font-nws text-gray-500 mb-6">
          In the meantime, check out our <Link href="/services" className="text-pink-600">Services</Link> and
          <Link href="/#testimonials" className="text-pink-600"> Testimonials</Link> to learn more about what we offer!
        </p>
        <button
