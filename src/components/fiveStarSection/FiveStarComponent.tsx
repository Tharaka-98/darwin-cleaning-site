...
const FiveStarComponent = () => {
  return (
    <section>
      <div className="h-[100px] gap-4 text-[#033286]  border-y-2 flex justify-center items-center font-poppins font-medium bg-gradient-to-l from-white dark:from-white  to-[#afecdc] px-4 text-[14px] md:text-[20px] lg:text-[24px] xl:text-[30px]  ">
