...
export default function HeroSection() {
  return (
    <section className="relative h-screen w-full">
      ...
      {/* Overlay Content */}
      <div className="absolute inset-0 px-6 lg:px-10 xl:px-20  z-50 flex lg:pt-48 xl:pt-44 md:pt-36 flex-col md:flex-row justify-center pt-80  md:justify-center  text-[#243056]">
        <div className="w-full md:w-1/2">
          <div className=" z-50 md:mt-28 space-y-4">
            <div className="text-[32px] mb-0 md:text-[50px] font-poppins lg:text-[40px] xl:text-[72px]  font-semibold leading-tight ">
        ...
        <div className="w-full md:w-1/2 relative flex justify-end items-end">
          <div className=" w-fit border-6 md:block hidden border-gray-200  rounded-tl-[90px]  ">
            <Image
              ...
              width={300}
              height={600}
              className="object-cover object-center rounded-tl-[84px] lg:w-[250px] xl:w-full"
              priority
            />
          </div>
          <div className=" xl:left-40 left-20 md:block hidden absolute bottom-0 w-fit border-6 border-white  rounded-tl-[38px]  rounded-br-[32px]">
            <Image
          ...
          <div className=" xl:left-40 left-20 block md:hidden absolute bottom-[260px] w-fit border-6 border-white  rounded-tl-[38px]  rounded-br-[32px]">
            <Image
